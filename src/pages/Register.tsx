...
import { EyeIcon, EyeOffIcon, Loader2, Check, X, Mail, Lock, Calendar, User, AlertTriangle, KeyRound } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button 
                type="submit" 
                className="w-full" 
                disabled={loading || (!twoFactorPending && !acceptTerms)}
              >
                {loading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                {twoFactorPending ? "Verificar" : "Criar conta"}
              </Button>
